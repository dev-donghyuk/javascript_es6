$(document).ready(function(){
	$(function(){
			$('.m_gnb>li').click(function(){
				...
				$(this).find('.depth2').stop().slideToggle(400).parents('li').siblings().find('.depth2').stop().slideUp(400)
			});
			...
			var mySwiper2 = new Swiper ('.video_slider', {
		    //direction: 'vertical',
		    loop: true,
		    effect:'fade',
		    autoplay:{
		    ...
		    // on:{
		    // 	init:function(){
		    // 		//데스크탑에서 첫번째 비디오 플레이 부분
		    // 		if($(window).width()+17>=1170){
		    // 			$('#video_1')[0].play()
		    // 		}
		    // 	}
		    // },
			...
			mySwiper2.on('transitionStart',playVideo);
