...
function initialize() {
			...
			*/
			...
			var Y_point			= 37.606449;		// Y 좌표
			var X_point			= 127.094753;		// X 좌표

			var zoomLevel		= 15;						// 첫 로딩시 보일 지도의 확대 레벨

			var markerTitle		= "맥도날드 신내점";				// 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
			...
			var contentString	= '<div id="content">' +
					...
					'<div id="bodyContent">'+ 
						'<p>맥도날드 신내점입니다!. <br /><a href="http:/www.ezen.co.kr" target="_blank">http:/www.ezen.co.kr</a></p>'+	
					'</div>'+ 
				'</div>';
